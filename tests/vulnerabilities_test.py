...
class EngineTest(BaseTestCase):
    ...
    def test_is_sanitized_false(self):
        cfg_node_1 = Node('Not sanitising at all', None, line_number=None)
        cfg_node_2 = Node('something.replace("this", "with this")', None, line_number=None)
    ...
    def test_is_sanitized_true(self):
        cfg_node_1 = Node('Awesome sanitiser', None,  line_number=None)
        cfg_node_2 = Node('something.replace("this", "with this")', None, line_number=None)
